...
class AccountingState extends State<AdminAccountingPage> {
              ...
              Expanded(
                ...
                child: SizedBox(
                    ...
                    child: CommonButtonWidget(
                      ...
                      borderWidth: 2,
                      text: 'Add Player',padding: AppConstants.ten, )),
              ),
              ...
              Expanded(
                ...
                child: SizedBox(
                    ...
                    child: CommonButtonWidget(
                      ...
                      onPressed: (){
                        AppUtils.redirectToNextScreen(context: context,screenName: RouteName.adminTotalAccountDetails);
                      },
                      left: 5,

                      text: 'Show Totals',padding: AppConstants.ten, )),
              )
            ],
          ),
        ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                CommonTextWidget(text: 'Player Name',fontWeight: FontWeight.w700,),
                AppUtils.commonInkWell(
                  child: Row(
                    children: [
                      AppUtils.commonImageSVGWidget(path: icEdit),
                      CommonTextWidget(left:10,text: 'Add Note',fontWeight: FontWeight.w700,textColor: AppColor.colorEdit,textDecoration: TextDecoration.underline,),
            ...
            IntrinsicHeight(
              child: Row(
                ...
                children: [
                  Flexible(
              flex: 4,child: commonRow(text1: 'Credit',text2: 'Time',text3: 'Total')),
                  commonDivider(),
                  Expanded(
                      flex: 6,
                      child: commonRow(text1: 'Cash out',text2: 'Time',text3: 'End Balance')),
            ...
            IntrinsicHeight(
              child: Row(
                ...
                children: [
                  Expanded(
                      flex: 4,
                      child: commonRow(text1: '500',text2: '4:30 pm',text3: '2,000',colorText: AppColor.colorWhite)),
                  commonDivider(),
                  Expanded(
                      flex: 6,child: commonRow(text1: '500',text2: '4:30 pm',text3: '2,000',colorText: AppColor.colorWhite)),
            ...
            IntrinsicHeight(
              child: Row(
                ...
                children: [
                  Expanded(
              flex: 4,child: commonRow(text1: '500',text2: '4:30 pm',text3: '2,000',colorText: AppColor.colorWhite)),
                  commonDivider(),
                  Expanded(
                      flex: 6,child: commonRow(text1: '500',text2: '4:30 pm',text3: '2,000',colorText: AppColor.colorWhite)),
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: CommonTextWidget(text: 'NLH 2/5 Behind Startford',fontWeight: FontWeight.w500,fontSize:14 ,),
              ),
              ...
              ListTile(
                ...
                title: Row(
                  children: [
                    CommonTextWidget(text: '4 Reservation',fontWeight: FontWeight.w500,fontSize:14 ,),
                    CommonTextWidget(text: 'Show members',fontWeight: FontWeight.w500,fontSize:14 ,left: 10,textDecoration: TextDecoration.underline,textColor: AppColor.colorEdit,),
                  ],
                ),
              )
  ...
  Widget commonList({String? text,Color?colorText,f}){
    return CommonTextWidget(text:text,textColor: colorText??AppColor.colorWhite,left: 2,fontSize: 12,);
  }
