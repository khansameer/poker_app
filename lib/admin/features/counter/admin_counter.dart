              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      commonTopView(),
                      Expanded(child: commonTopView(price:'500',desc: 'Your Chips ',left: 5)),
      ...
      widget: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CommonTextWidget(
              margintop: 4,
              text: desc??"Total Chips available to\nsend out",fontSize: 10,textAlign: TextAlign.center,textColor: AppColor.colorWhite.withOpacity(0.7),)
          ],
        ),
      )
    );
